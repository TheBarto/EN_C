...
#define GUARDARVALORESEXTRA(x, y) (x->valoresCapturaExtra[x->totalValoresCapturaExtraAniadidos] = y)
#define TOTALVALORESEXTRA(x) (x->totalValoresCapturaExtraAniadidos)
